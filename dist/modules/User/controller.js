...
var UserController = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.get()];
                    case 1:
                        users = _a.sent();
    ...
    UserController.prototype.signin = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, userService, token, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, email = _a.email, password = _a.password;
                        userService = new service_1.default();
                        return [4 /*yield*/, userService.generateToken({ email: email, password: password })];
                    case 1:
                        token = _b.sent();
                        if (!token)
                            throw new Error();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        userService = new service_1.default();
                        return [4 /*yield*/, userService.validateToken(token)];
                    case 1:
                        user = _a.sent();
